    ...
    <section className="sign-up-success mx-auto pt-md-179 pb-md-179 pt-150 pb-100">
        <div className="container-fluid">
            <div className="text-center">
                <Image src="/img/sign-up-success-1.png" width={316} height={300} alt="success" />
            </div>
            ...
            <div className="button-group d-flex flex-column mx-auto">
                <a className="btn btn-top-up fw-medium text-lg text-white rounded-pill" href="/" role="button">Top Up</a>
            </div>
        </div>
    </section>
  )
