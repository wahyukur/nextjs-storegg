    ...
    <section className="not-found mx-auto pt-145 pb-md-212 pb-100">
        <div className="container-fluid">
            <div className="text-center">
                <Image src="/img/404-1.png" width={483} height={300} alt="404" />
            </div>
            ...
            <div className="button-group d-flex flex-column mx-auto">
                <Link className="btn btn-homepage fw-medium text-lg text-white rounded-pill" href="/" role="button">Homepage</Link>
            </div>
        </div>
    </section>
  )
