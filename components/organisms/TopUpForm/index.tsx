            ...
            <div className="pt-md-50 pb-md-50 pt-30 pb-20">
                ...
                <div className="row justify-content-between">
                    {nominals.map((nominal) => {
                        return <NominalItem key={nominal._id} _id={nominal._id} coinQuantity={nominal.coinQuantity} coinName={nominal.coinName} price={nominal.price} />
                    })}
                    ...
                    <div className="row justify-content-between">
                        {payments.map((payment) => {
                            return payment.banks.map((bank) => {
                                return <PaymentItem bankID={bank._id} type={payment.type} name={bank.bankName} />
                            })
                        })}
